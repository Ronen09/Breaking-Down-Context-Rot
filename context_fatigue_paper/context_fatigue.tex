...
\begin{itemize}
  ...
  \item \textbf{Competition} is a \emph{second} mechanism, costing accuracy at
        constant \emph{evidence} mass. Closing the competitor mentions recovers $59\%$ of
...
(random, $n{=}699$) and $+0.01$ (coherent, $n{=}1001$), computed over fill $<0.8$, and the
nulls are \emph{bounded}---at
$95\%$, hidden declines larger than $4.1$ points (coherent) or $9.4$ (random) are excluded.
...
precision (4.1 points coherent, 9.4 random), so we claim no decline surfaces, not that
