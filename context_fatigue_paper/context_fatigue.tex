...
\begin{table}[H]
  ...
  bisection rows $n{=}23$. $\Delta\Delta$ $=$ shift of the instructed-formats
  log-probability contrast, against a self-patch baseline.}
  \label{tab:patch}
  \setlength{\tabcolsep}{5pt}
  \begin{tabular}{lcc}
    \toprule
...
$\Delta\Delta$ is a difference-in-differences against a \emph{self-patch} baseline: the
...
baseline the same control is null.
